...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block_3_testimonials_frontend__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__block_4_instafeed_frontend__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_slick_carousel__ = __webpack_require__(73);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_instagram_embed__ = __webpack_require__(75);
...
var render = __WEBPACK_IMPORTED_MODULE_1_wp___default.a.element.render;

var instafeed = document.querySelectorAll('.wp-block-agencykit-instafeed');

instafeed.forEach(function (feed, index) {
	var instagramId = 'https://instagram.com/p/' + feed.dataset.user;
	var embedWidth = feed.dataset.width;
	render(__WEBPACK_IMPORTED_MODULE_1_wp___default.a.element.createElement(__WEBPACK_IMPORTED_MODULE_0_react_instagram_embed__["a" /* default */], { key: index,
		url: instagramId,
		maxWidth: embedWidth,
		hideCaption: false,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_query_string__ = __webpack_require__(77);
...
var InstagramEmbed = /** @class */ (function (_super) {
    ...
    InstagramEmbed.prototype.render = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Tag, __assign({}, this.omitComponentProps(), { dangerouslySetInnerHTML: { __html: this.state.html || '' } }));
    };
    ...
    InstagramEmbed.prototype.getQueryParams = function (_a) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_query_string__["stringify"]({
            url: url,
...
var decodeComponent = __webpack_require__(80);
