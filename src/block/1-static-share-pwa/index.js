	...
	edit: ( { className } ) => {
		return (
			<div className={ className + ' mdc-card' }>
				<a href="https://twitter.com/share?url=https%3A%2F%2Fblog.fellyph.com.br%2F&text=Blog%20fellyph%20Cintra&via=fellyph" className={ 'mdc-button mdc-button--raised' } >
					<span className={ 'mdc-button__label' } >{ __( 'Tweet it' ) }</span>
				</a>
				<a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblog.fellyph.com.br%2F" className={ 'mdc-button mdc-button--raised' }>
					<span className={ 'mdc-button__label' } >{ __( 'Share on Facebook' ) }</span>
				</a>
				<a href="http://www.linkedin.com/shareArticle?url=https%3A%2F%2Fblog.fellyph.com.br%2F&title=Blog%20fellyph%20Cintra" className={ 'mdc-button mdc-button--raised' }>
	...
	save: ( { className } ) => {
		return (
			<div className={ className + ' mdc-card' }>
				...
				<button className={ 'material-icons share-button mdc-icon-button mdc-card__action mdc-card__action--icon' } title={ __( 'Share' ) }>
					{ __( 'Share' ) }
				</button>
			</div>
		);
